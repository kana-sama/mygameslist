...
Простая направленная цепочка узлов автоматически идёт слева направо, если во
внутренней ширине контейнера хватает места на карточки шириной не менее 116 px
и промежутки по 22 px. Карточки делят доступную ширину поровну, до 220 px каждая;
подписи переносятся без уменьшения шрифта. При нехватке места цепочка остаётся
вертикальной. Это работает и для связанных корневых узлов, и внутри групп/секций;
вложенные отступы учитываются. Сами контейнеры групп ради строки не сужаются.
Цепочки со связями с
